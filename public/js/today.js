...
async function main(){
    ...
    var schedule = await window.db.getSchedule();
    document.querySelector("#header").innerHTML = `${monthText[parseInt(schedule.date.substring(5,7))]} ${addSubText(schedule.date.substring(8))}, ${schedule.date.substring(0, 4)}`;
