...
var schedule = new Proxy(schema, {
    set: function(target, key, value){
        ...
        window.db.updateNewSchedule(target);
...
document.querySelector(".nextone").addEventListener("click", function(e){
    var date_input = document.querySelector("#date");
    if(!e.target.classList.contains("disabled") && date_input.value != ""){
        schedule.date = date_input.value;
